<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="vipList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="序号" align="center" prop="vipId" />
      ...
      <el-table-column label="有效期" align="center" prop="expire" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="有效期" prop="expire">
          <el-input v-model="form.expire" placeholder="请输入有效期" />
        </el-form-item>
        <el-form-item label="等级名称" prop="name">
  ...
  export default {
    ...
    methods: {
      ...
      handleDelete(row) {
        ...
        this.$confirm('是否确认删除vip会员等级编号为"' + vipIds + '"的数据项?', "警告", {
      ...
      handleExport() {
        ...
        this.$confirm('是否确认导出所有vip会员等级数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
