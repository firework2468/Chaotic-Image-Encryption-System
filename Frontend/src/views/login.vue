  ...
  <div class="login">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form">
      ...
      <el-form-item prop="userType">
        <el-radio v-model="loginForm.userType" label="register">客户端</el-radio>
        <el-radio v-model="loginForm.userType" label="00">管理端</el-radio>
      </el-form-item>
    ...
    handleLogin() {
      this.$refs.loginForm.validate(valid => {
        if (valid) {
          ...
          const userType = this.loginForm.userType;
          ...
          this.$store.dispatch("Login", this.loginForm).then(() => {
            ...
            if ("00" == userType){
              ...
              this.$router.push({ path: this.redirect || "/portal/index" }).catch(()=>{});
            }
          }).catch(() => {
            this.loading = false;
            this.getCode();
